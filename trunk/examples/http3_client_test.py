...
if __name__ == "__main__":
    ...
    ## URL profile: ignore given url and use a set of urls provided by the script
    parser.add_argument(
        "--url-profile", type=str, help="Name of the URL profile (large-data-test)"
    )
    ...
    # URLs to request
    mainURL = ""
    if (args.url_profile == "large-data-test"):
        """
        urls.append("https://127.0.0.1:443/999")
        urls.append("https://127.0.0.1:443/998")
        urls.append("https://127.0.0.1:443/997")
        urls.append("https://127.0.0.1:443/996")
        urls.append("https://127.0.0.1:443/995")
        urls.append("https://127.0.0.1:443/994")
        urls.append("https://127.0.0.1:443/993")
        """
        urls.append("https://127.0.0.1:443/9999999")
        urls.append("https://127.0.0.1:443/9999998")
        urls.append("https://127.0.0.1:443/9999997")
        urls.append("https://127.0.0.1:443/9999996")
        urls.append("https://127.0.0.1:443/9999995")
        urls.append("https://127.0.0.1:443/9999994")
        urls.append("https://127.0.0.1:443/9999993")
    ...
    # Custom Tests - Kobe
    ###
    elif experiment == "custom-large-data-test":
        for i in range(request_count):
            delays.append(1)
            requestHeaders = RequestPriorityConfiguration(urgency=7-i, incremental=True, delay=0.1)
            headers.append(requestHeaders)
            newUrgency =( 13-i )% 7
            priorityFrame = RequestPriorityConfiguration(urgency=newUrgency, incremental=True, delay=0.1)
            pre_request_prio_frames.append(None)
            #post_request_prio_frames.append(None)
            post_request_prio_frames.append(priorityFrame)
            reprioritization_frames.append(None)

            #reprioritization_frames.append(priorityFrame)
